...
[open an issue](https://github.com/Workiva/abide/issues/new) and fill out
the issue template with as much detail as necessary.

###### Workiva Employees
> __Contact us on Slack:__ [\#support-abide](https://workiva.slack.com/app_redirect?channel=support-abide)

Have a bug to report or an improvement/feature to request?
Please contact us on Slack or [create a JIRA ticket](https://jira.atl.workiva.net/secure/CreateIssue!default.jspa?pid=CPLAT&component=abide)
and fill out the description with as much detail as necessary.

## Contributing Changes
If you're contributing a change to abide, please follow this process: (and
thank you!)
